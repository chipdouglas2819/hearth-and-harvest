...
const CROPS = {
  ...
  strawberry: { growthHrs: 18, plantCost: 80,  baseYield: 400,  pickCount: 3 },
  wheat:      { growthHrs: 24, plantCost: 100, baseYield: 540,  pickCount: 5 },
...
const BUFF_POOL = [
  // common
  { id: 'sun',      name: 'Sunny Days',     rarity: 'common',   yieldMult: 1.18 },
  { id: 'rain',     name: 'Gentle Rain',    rarity: 'common',   timeMult: 0.78 },
  { id: 'rich',     name: 'Rich Soil',      rarity: 'common',   yieldMult: 1.22 },
  { id: 'compost',  name: 'Compost Tea',    rarity: 'common',   yieldMult: 1.12, timeMult: 0.90 },
  { id: 'sprout',   name: 'Eager Sprout',   rarity: 'common',   timeMult: 0.75 },
  { id: 'sturdy',   name: 'Sturdy Stems',   rarity: 'common',   yieldMult: 1.15 },
  { id: 'patient',  name: 'Slow & Steady',  rarity: 'common',   yieldMult: 1.28, timeMult: 1.10 },
  ...
  { id: 'tradeoff_a', name: 'Long Patience', rarity: 'uncommon', yieldMult: 1.45, timeMult: 1.18 },
  ...
  { id: 'long_wait', name: 'The Long Wait', rarity: 'legendary', yieldMult: 2.20, timeMult: 1.40 },
